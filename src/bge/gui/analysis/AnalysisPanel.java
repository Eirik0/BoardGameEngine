...
import bge.game.PositionChangedInfo;
...
public class AnalysisPanel<M> extends JPanel {
    ...
    public static JScrollPane createScrollPane(boolean verticalScrollBarAlways) {
        ...
        scrollPane.setVerticalScrollBarPolicy(
                verticalScrollBarAlways ? ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS : ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
    ...
    public void positionChanged(PositionChangedInfo<M> positionChangedInfo) {
        ...
        if (player != null && player instanceof ComputerPlayer) {
            analysisState.stopAnalysis();
            ComputerPlayerObservationState<M> computerObservationState = new ComputerPlayerObservationState<>((ComputerPlayer) player,
                    position.getCurrentPlayer());
            setAnalysisState(computerObservationState);
            computerObservationState.setSize(analysisPanel.getWidth(), analysisPanel.getHeight());
