...
public class ComputerPlayerObserver implements Drawable, Sizable {
    ...
    public void drawOn(Graphics2D graphics) {
        ...
        while (i < currentMoves.size()) {
            ...
            graphics.setColor(moveWithScore.isPartial || AnalysisResult.isGameOver(moveWithScore.score) ? BoardGameEngineMain.FOREGROUND_COLOR
                    : BoardGameEngineMain.LIGHTER_FOREGROUND_COLOR);
