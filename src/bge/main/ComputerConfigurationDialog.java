...
import bge.main.PlayerSelectionPanel.PlayerSelectionItem;
...
public class ComputerConfigurationDialog {
    ...
    public ComputerConfigurationDialog(JComboBox<PlayerSelectionPanel.PlayerSelectionItem> playerComboBox, String gameName,
            ComputerPlayerInfo<?, ?> computerPlayerInfo, boolean infiniteTimeOnly) {
        ...
        configurationFrame.setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
