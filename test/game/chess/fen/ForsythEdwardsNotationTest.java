...
import game.chess.ChessPositionTest;
...
public class ForsythEdwardsNotationTest {
	...
	public void testStringToInitialPosition() {
		ChessPositionTest.assertPositionsEqual(new ChessPosition(), ForsythEdwardsNotation.stringToPosition("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"));
	}
}
