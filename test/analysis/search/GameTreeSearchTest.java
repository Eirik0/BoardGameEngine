...
public class GameTreeSearchTest {
    ...
    public void testSearch() {
        ...
        GameTreeSearch<TestGameNode, TestGamePosition> treeSearch = newGameTreeSearch(TestGamePosition.createTestPosition(), 1, 2, new TestGameEvaluator(),
                results);
        treeSearch.search();
    ...
    public void testFork_NotRunning() {
        ...
        GameTreeSearch<TestLockingNode, TestLockingPosition> treeSearch = newGameTreeSearch(testUnlockedLockingPosition, 1, 3, new TestLockingEvaluator(),
                results);
    ...
    public void testFork() {
        ...
        List<AnalysisResult<TestLockingNode>> results = new ArrayList<>();
        GameTreeSearch<TestLockingNode, TestLockingPosition> treeSearch = newGameTreeSearch(testUnlockedLockingPosition, 1, 2, new TestLockingEvaluator(),
                results);
