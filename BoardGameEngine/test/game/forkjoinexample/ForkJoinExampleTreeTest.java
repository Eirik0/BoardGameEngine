...
public class ForkJoinExampleTreeTest {
	...
	public void testCreateTreeOfDepthZero() {
		assertNull(ForkJoinExampleTree.createTree(0, 2));
	}

	@Test
	public void testCreateTreeOfDepthOne() {
		ForkJoinExampleNode createTreeOfDepth = ForkJoinExampleTree.createTree(1, 2);
		assertEquals(0, createTreeOfDepth.getChildren().size());
	}

	@Test
	public void testCreateTreeOfDepthTwo() {
		ForkJoinExampleNode createTreeOfDepth = ForkJoinExampleTree.createTree(2, 2);
