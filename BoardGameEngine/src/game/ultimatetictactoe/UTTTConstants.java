...
public class UTTTConstants {
	...
	static {
		for (int board = 0; board < MAX_BOARD_NUM; ++board) {
			...
			hasPossibleWins[board] = UltimateTicTacToeUtilities.hasPossibleWins(board, TwoPlayers.PLAYER_1);
			hasPossibleWins[PLAYER_2_MASK | board] = UltimateTicTacToeUtilities.hasPossibleWins(board, TwoPlayers.PLAYER_2);
			...
			countPossibleWins[board] = UltimateTicTacToeUtilities.countPossibleWins(board, TwoPlayers.PLAYER_1);
			countPossibleWins[PLAYER_2_MASK | board] = UltimateTicTacToeUtilities.countPossibleWins(board, TwoPlayers.PLAYER_2);
